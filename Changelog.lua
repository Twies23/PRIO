...
local ENTRIES = {
    { "0.9.1", {
        ...
        "Pick a raid and PRIO force-loads its BigWigs modules on demand -- browse every boss and its abilities without pulling or even entering the instance. Cached so they persist afterward.",
    ...
    { "0.8.0", {
        ...
        "Conduit: Xuen -> Celestial Conduit -> Zenith burst; Celestial Conduit now also needs Whirling Dragon Punch on cooldown.",
        "New Rotation Debug window (/prio rotdebug), proc glows as named editor conditions, and hero-split configurable openers. Reset lists + openers to default to pick up the tuned defaults.",
    } },
    { "0.7.22", {
    ...
    { "0.7.15", {
        "Windwalker glow signals are now pickable conditions in the editor: 'Zenith lit up (20 Tigereye stacks)', 'Blackout Kick! proc', and 'Dance of Chi-Ji proc', plus 'Heart of the Jade Serpent up' and 'Zenith window active'.",
    } },
    { "0.7.14", {
